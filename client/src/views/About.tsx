    ...
    return (
        <div className="font-['Urbanist'] bg-gray-50 min-h-screen relative overflow-hidden">
            ...
            <main className="pt-32 pb-6 px-6 sm:px-10 lg:px-24 max-w-7xl mx-auto relative z-10 space-y-24">
                ...
                {/* Founders Section */}
                <Reveal>
                    <section className="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden lg:min-h-[60vh] flex">
                        <div className="flex flex-col lg:flex-row w-full">
                            ...
                            <div className="h-80 sm:h-[450px] lg:h-auto lg:min-h-full lg:w-2/5 relative bg-gray-200 group overflow-hidden shrink-0">
                                <img
                                    ...
                                    alt={`${founders[0].role} of Our Home Tuition`}
                                    title={`${founders[0].role} - Leadership`}
                            ...
                            <div className="p-6 lg:p-10 flex flex-col justify-start lg:w-3/5">
                                <div className="inline-block px-4 py-1.5 bg-[#c75e33]/10 rounded-full text-[#c75e33] font-bold text-sm mb-4 w-max uppercase tracking-wide">Leadership</div>
                                <h2 className="text-2xl lg:text-3xl font-extrabold text-[#17242e] mb-4">Meet Our CEO</h2>
                ...
                {/* Approach Section */}
                <Reveal>
                    <section className="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden p-6 lg:p-10">
