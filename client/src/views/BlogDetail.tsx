        ...
        return (
            <div className="min-h-screen bg-gray-50 flex items-center justify-center font-['Urbanist']">
                <div className="text-center">
                    ...
                    <Link href="/blogs" className="text-[#a0522d] font-black uppercase tracking-widest text-xs">Back to all blogs</Link>
                </div>
            </div>
        );
    }
            ...
            <main className="flex-grow pt-32 pb-20">
                <article className="max-w-4xl mx-auto px-6">
                    ...
                    <div className="flex justify-between items-center mb-12">
                        <Link href="/blogs" className="flex items-center gap-2 text-gray-400 font-black text-[10px] uppercase tracking-widest hover:text-[#a0522d] transition-colors">
