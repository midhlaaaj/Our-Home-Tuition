        ...
        <div className="font-['Urbanist'] bg-gray-50 min-h-screen relative overflow-hidden">
            ...
            <main className="pt-32 pb-6 px-6 sm:px-10 lg:px-24 max-w-7xl mx-auto relative z-10 space-y-24">
                ...
                <section className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    {/* Vision Card */}
                    <div className="bg-white rounded-3xl p-10 shadow-sm border border-gray-100 hover:shadow-md transition-shadow duration-300 relative overflow-hidden group">
                    ...
                    {/* Mission Card */}
                    <div className="bg-[#17242e] rounded-3xl p-10 shadow-sm hover:shadow-md transition-shadow duration-300 relative overflow-hidden group">
