    ...
    return (
        <section className="w-full bg-gray-200 pt-16 pb-8 overflow-hidden relative">
            ...
            <button
                ...
                className="absolute left-2 md:left-6 top-1/2 -translate-y-1/2 z-30 w-11 h-11 rounded-full bg-white shadow-md border border-gray-200 flex items-center justify-center text-gray-600 hover:bg-[#ffb76c] hover:text-white hover:border-[#ffb76c] transition-all"
            ...
            <button
                ...
                className="absolute right-2 md:right-6 top-1/2 -translate-y-1/2 z-30 w-11 h-11 rounded-full bg-white shadow-md border border-gray-200 flex items-center justify-center text-gray-600 hover:bg-[#ffb76c] hover:text-white hover:border-[#ffb76c] transition-all"
